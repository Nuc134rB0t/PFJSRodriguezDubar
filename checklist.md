...
[X] AJAX.
[X] JSON para obtener datos.
    - products.json
    - API coingecko.
[X] Diversas herramientas de JS como librerías
    - Luxon.
[X] Promises.
[X] Asincronía para controlar eventos en la interfaz y producir animaciones en respuesta.
-
[X] Condicionales if.
[X] Ternarios.
[X] Funciones.
